...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('purchase_returns', function (Blueprint $table) {
            ...
            $table->index(['company_id', 'branch_id'], 'idx_purchase_returns_company_branch');
            $table->index(['purchase_order_id', 'return_date'], 'idx_purchase_returns_po_date');
            $table->index('status', 'idx_purchase_returns_status');
            $table->index('reason_code', 'idx_purchase_returns_reason');
        });
    }
