            ...
            <div class="bg-white shadow-sm sm:rounded border border-gray-200">
                <div class="text-gray-900">
                    <AppDataTable
                        ...
                        importRoute="assets.import"
                        importTemplateRoute="assets.import-template"
                        importTitle="Impor Aset (Saldo Awal)"
                        importDescription="Unggah berkas CSV atau Excel. Tiap baris membuat satu aset; jadwal penyusutan dibuat otomatis untuk sisa umur ekonomis (bulan-bulan yang sudah dibukukan via 'akumulasi_penyusutan' dilewati). Catat saldo awal GL secara terpisah per kategori."
