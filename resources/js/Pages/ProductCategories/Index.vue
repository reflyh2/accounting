            ...
            <div class="bg-white shadow-sm sm:rounded border border-gray-200">
                <div class="text-gray-900">
                    <AppDataTable
                        ...
                        importRoute="catalog.product-categories.import"
                        importTemplateRoute="catalog.product-categories.import-template"
                        importTitle="Impor Kategori Produk"
                        importDescription="Unggah berkas CSV atau Excel untuk membuat kategori secara massal. Induk kategori harus sudah ada atau tercantum di baris sebelumnya."
