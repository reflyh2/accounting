...
function deleteItem(id) {
    ...
    router.delete(route('catalog.rental.destroy', id), {
        preserveScroll: true,
        preserveState: true,
        data: {
            preserveState: true,
...
function handleSort(newSort) {
    ...
    router.get(route('catalog.rental.index'), {
        ...route().params,
...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="min-w-max sm:min-w-min md:max-w-full mx-auto">
            <ProductCatalogTabs activeTab="catalog.rental.index" />
            ...
            <div class="bg-white shadow-sm sm:rounded border border-gray-200">
                <div class="text-gray-900">
                    <AppDataTable
                        ...
                        :createRoute="{ name: 'catalog.rental.create' }"
                        :editRoute="{ name: 'catalog.rental.edit' }"
                        :deleteRoute="{ name: 'catalog.rental.destroy' }"
                        :viewRoute="{ name: 'catalog.rental.show' }"
                        :indexRoute="{ name: 'catalog.rental.index' }"
                        :sortable="sortableColumns"
                        :defaultSort="defaultSort"
                        :currentSort="currentSort"
                        :perPage="perPage"
                        routeName="catalog.rental.index"
