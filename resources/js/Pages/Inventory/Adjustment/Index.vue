            ...
            <div class="bg-white shadow-sm sm:rounded border border-gray-200">
                <div class="text-gray-900">
                    <AppDataTable
                        ...
                        itemKey="id"
                        importRoute="inventory.adjustments.import"
                        importTemplateRoute="inventory.adjustments.import-template"
                        importTitle="Impor Saldo Awal"
                        importDescription="Unggah berkas CSV atau Excel. Tiap lokasi akan membuat satu dokumen penyesuaian pada tanggal di bawah dengan alasan 'Saldo awal (impor)'."
                        importButtonLabel="Impor Saldo Awal"
                        :importDateField="{ name: 'transaction_date', label: 'Tanggal Penyesuaian' }"
