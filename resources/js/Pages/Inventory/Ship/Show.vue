...
function deleteTransaction() {
    deleteForm.delete(route('inventory.shipments.destroy', props.transaction.id), {
        preserveScroll: true,
        onSuccess: () => {
...
<template>
    <Head :title="`Pengeluaran ${transaction.transaction_number}`" />
    <AuthenticatedLayout>
        <template #header>
            ...
            <div class="bg-white shadow-sm sm:rounded border border-gray-200">
                <div class="p-6 space-y-6">
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                        <AppBackLink :href="route('inventory.shipments.index')" text="Kembali ke daftar pengeluaran" />
                        <div class="flex items-center gap-2">
                            <AppEditButton :href="route('inventory.shipments.edit', transaction.id)" />
                    ...
                    <div class="grid md:grid-cols-2 gap-4 text-sm">
                        ...
                        <div>
                            <p class="text-gray-500">Lokasi Sumber</p>
                        ...
                        <div>
                            <p class="text-gray-500">Nilai Terkonsumsi</p>
                            <p class="font-semibold">
                            ...
                            <table class="min-w-full border border-gray-200 text-sm">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th class="px-3 py-2 border border-gray-200 text-right">Harga Rata-rata</th>
