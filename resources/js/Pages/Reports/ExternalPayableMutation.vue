...
function generateReport() {
  router.get(route('external-payable-mutation.index'), form.value, {
    preserveState: true,
    preserveScroll: true,
  });
}
...
function downloadReport(format) {
  ...
  window.open(route('external-payable-mutation.download', params));
}
</script>

<template>
  <Head title="Mutasi Hutang" />
  ...
  <AuthenticatedLayout>
    ...
    <div class="mx-auto">
      <PayableReceivableReportTabs activeTab="external-payable-mutation.index" />
