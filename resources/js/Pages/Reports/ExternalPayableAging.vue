...
function generateReport() {
   router.get(route('external-payable-aging.index'), form.value, {
      preserveState: true,
      preserveScroll: true,
   });
}
...
function downloadReport(format) {
   ...
   window.open(route('external-payable-aging.download', params));
}
</script>

<template>
   <Head title="Umur Hutang" />
   ...
   <AuthenticatedLayout>
      ...
      <div class="mx-auto">
         <PayableReceivableReportTabs activeTab="external-payable-aging.index" />
