...
function generateReport() {
  router.get(route('external-receivable-card.index'), form.value, {
    preserveState: true,
    preserveScroll: true,
  });
}
...
function downloadReport(format) {
  ...
  window.open(route('external-receivable-card.download', params));
}
</script>
...
<template>
  ...
  <AuthenticatedLayout>
    ...
    <div class="mx-auto">
      <PayableReceivableReportTabs activeTab="external-receivable-card.index" />
                      ...
                      <ReportTD>
                        <template v-if="!row.is_opening && row.doc_number">
                          <a
                            ...
                            :href="route('external-receivables.show', row.doc_id)"
                            target="_blank"
                          ...
                          <a
                            ...
                            :href="route('external-receivable-payments.show', row.doc_id)"
                            target="_blank"
                            class="text-main-500 hover:text-main-800"
                          >
                            {{ row.doc_number }}
