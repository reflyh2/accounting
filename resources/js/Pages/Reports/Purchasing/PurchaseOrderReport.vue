...
function generateReport() {
    router.get(route('purchasing-reports.orders'), form.value, {
        preserveState: false,
        preserveScroll: true,
    });
}
...
<template>
    <Head title="Laporan Purchase Order" />
    ...
    <AuthenticatedLayout>
        ...
        <div class="mx-auto">
            <PurchasingReportTabs activeTab="purchasing-reports.orders" />
            ...
            <div class="bg-white shadow-sm sm:rounded border border-gray-200">
                <div class="p-6 text-gray-900">
                    ...
                    <div v-if="totals" class="mb-4 p-4 bg-blue-50 rounded-lg flex gap-8">
                        <div>
                            <span class="text-sm text-blue-600">Total PO:</span>
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        <tr v-for="(item, idx) in group.items" :key="idx" class="hover:bg-gray-50">
                                            <td class="px-4 py-2 text-sm">
                                                <Link :href="route('purchase-orders.show', item.document.id)" class="text-blue-600 hover:underline">
                                ...
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        <tr v-for="item in group.items" :key="item.id" class="hover:bg-gray-50">
                                            <td class="px-4 py-2 text-sm">
                                                <Link :href="route('purchase-orders.show', item.id)" class="text-blue-600 hover:underline">
                                                    {{ item.order_number }}
                                                </Link>
                                            </td>
