...
<template>
    <Head title="Tambah Entri Penyusutan" />

    <AuthenticatedLayout>
        <template #header>
            <h2>Tambah Entri Penyusutan</h2>
        </template>
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-6">
                        ...
                        <div>
                            ...
                            <p class="font-medium">{{ depreciationMethods.find(method => method.value === asset.depreciation_method)?.label || 'Garis Lurus (default)' }}</p>
                        </div>
                        <div>
