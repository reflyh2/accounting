...
const tabs = ref([
    ...
    { label: 'Anggota', route: 'members.index', active: true },
...
function handleBulkDelete(ids) {
    ...
    router.delete(route('members.bulk-delete'), {
        preserveScroll: true,
        preserveState: true,
        data: {
            preserveState: true,
            ...
            <div class="bg-white shadow-sm sm:rounded border border-gray-200">
                <div class="text-gray-900">
                    <AppDataTable
                        ...
                        :createRoute="{ name: 'members.create' }"
                        :editRoute="{ name: 'members.edit' }"
                        :deleteRoute="{ name: 'members.destroy' }"
                        :viewRoute="{ name: 'members.show' }"
                        :indexRoute="{ name: 'members.index' }"
                        :customFilters="customFilters"
                        :downloadOptions="downloadOptions"
                        downloadBaseRoute="members"
