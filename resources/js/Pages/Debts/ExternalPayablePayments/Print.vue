...
<template>
    <Head title="Cetak Pembayaran Hutang" />
    <div class="p-8 text-sm text-gray-900">
        <div class="flex justify-between items-center mb-6">
            <div>
                <h1 class="text-xl font-bold">Pembayaran Hutang</h1>
        ...
        <div class="grid grid-cols-2 gap-4 mb-6">
            ...
            <div>
                ...
                <p><span class="font-semibold">Metode:</span> {{ paymentMethodOptions[item.payment_method] || '-' }}</p>
