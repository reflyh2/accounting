            ...
            <div class="bg-white shadow-sm sm:rounded border border-gray-200">
                <div class="text-gray-900">
                    <AppDataTable
                        ...
                        itemKey="id"
                        importRoute="external-receivables.import"
                        importTemplateRoute="external-receivables.import-template"
                        importTitle="Impor Saldo Awal Piutang"
                        importDescription="Unggah berkas CSV atau Excel. Tiap baris membuat satu piutang dan otomatis mencatat jurnal lawan ke akun yang dipilih (mis. Modal Awal)."
