                ...
                <div class="bg-white overflow-auto shadow-sm sm:rounded-s border-y border-l border-gray-200">
                    <div class="p-6 text-gray-900">
                        ...
                        <div class="mt-6 border-t border-gray-200 pt-4">
                            ...
                            <div v-if="partner.contacts.length > 0" class="grid grid-cols-1 gap-4">
                                <div v-for="(contact, index) in partner.contacts" :key="index" class="border border-gray-200 rounded p-4">
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 *:py-1 text-sm">
                                        <div>
