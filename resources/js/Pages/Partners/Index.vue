            ...
            <div class="bg-white shadow-sm sm:rounded border border-gray-200">
                <div class="text-gray-900">
                    <AppDataTable
                        ...
                        importRoute="partners.import"
                        importTemplateRoute="partners.import-template"
                        importTitle="Impor Partner"
                        importDescription="Unggah berkas CSV atau Excel untuk membuat partner secara massal. Kolom 'peran' menerima beberapa peran yang dipisahkan koma (mis. 'customer,supplier')."
