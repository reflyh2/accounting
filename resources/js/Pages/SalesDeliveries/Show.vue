            ...
            <div class="bg-white shadow-sm sm:rounded border border-gray-200 p-6 space-y-6">
                <div class="flex items-center justify-between flex-wrap gap-4">
                    ...
                    <div class="flex items-center gap-2">
                        <Link
                            v-if="delivery.sales_order"
                            :href="route('sales-orders.show', delivery.sales_order.id)"
                        >
                            <AppSecondaryButton>Lihat Sales Order</AppSecondaryButton>
                        </Link>
                    </div>
                </div>
                ...
                <div class="grid md:grid-cols-3 gap-6 text-sm">
                    <div>
                        <p class="text-gray-500">Sales Order</p>
                    ...
                    <div>
                        ...
                        <p class="font-semibold">
                            {{ delivery.sales_order?.partner?.name || '-' }}
                        </p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <p class="font-semibold capitalize">{{ delivery.status }}</p>
                    </div>
                </div>
