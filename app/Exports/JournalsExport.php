...
class JournalsExport extends DefaultValueBinder implements 
    FromCollection, 
    WithHeadings, 
    WithMapping, 
    ...
    ShouldAutoSize
{
    ...
    public function map($journal): array
    {
        return [
            ...
            $journal->description,
            $journal->branch->branchGroup->company->name,
            $journal->branch->name,
            number_format($journal->journal_entries_sum_primary_currency_debit, 2),
        ];
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                // Right-align the Total Debit and Total Credit columns
