...
class InternalDebt extends Model
{
    ...
    public function counterpartyJournal()
    {
        // Note: DB column is 'conterparty_journal_id' (typo in migration)
        return $this->belongsTo(Journal::class, 'conterparty_journal_id');
    }
    ...
    {
        return $this->hasOne(ExternalDebt::class);
    }

    public function internalDebt()
    {
        return $this->hasOne(InternalDebt::class);
    }
    ...
    public function counterpartyDebtAccount()
    {
        return $this->belongsTo(Account::class, 'counterparty_debt_account_id');
    }

    public function counterpartyOffsetAccount()
    {
        return $this->belongsTo(Account::class, 'counterparty_offset_account_id');
    }

    public function counterpartyBranch()
    {
        return $this->belongsTo(Branch::class, 'counterparty_branch_id');
    }
