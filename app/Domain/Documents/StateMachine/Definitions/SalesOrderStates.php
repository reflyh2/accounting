...
final class SalesOrderStates
{
    public static function definition(): DocumentStateMachineDefinition
    {
        return DocumentStateMachineDefinition::make(SalesOrderStatus::class)
            ...
            ->allow(DocumentStateTransition::make(SalesOrderStatus::CONFIRMED, SalesOrderStatus::CLOSED))
            ...
            ->allow(DocumentStateTransition::make(SalesOrderStatus::CLOSED, SalesOrderStatus::CONFIRMED))
            ->allow(DocumentStateTransition::make(SalesOrderStatus::CLOSED, SalesOrderStatus::DELIVERED))
            ->allow(DocumentStateTransition::make(SalesOrderStatus::CLOSED, SalesOrderStatus::PARTIALLY_DELIVERED))
