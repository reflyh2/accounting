    ...
    private function transformInvoice(SalesInvoice $invoice): array
    {
        return [
            ...
            'lines' => $invoice->lines->map(fn ($line) => [
                ...
                'secondary_quantity' => $line->secondary_quantity ? (float) $line->secondary_quantity : null,
        ...
        return Inertia::render('SalesInvoices/Print', [
            'salesInvoice' => [
                ...
                'lines' => $salesInvoice->lines->map(fn ($line) => [
                    ...
                    'uom_label' => $line->uom_label,
                    'quantity' => (float) $line->quantity,
                    'secondary_quantity' => $line->secondary_quantity !== null ? (float) $line->secondary_quantity : null,
                    'secondary_uom_label' => $line->secondary_uom_label,
                    'unit_price' => (float) $line->unit_price,
                    'discount_rate' => (float) $line->discount_rate,
                    'discount_amount' => (float) $line->discount_amount,
